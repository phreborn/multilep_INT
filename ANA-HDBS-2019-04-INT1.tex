...
\input{ANA-HDBS-2019-04-INT1-metadata}
...
\clearpage
\input{Tex/DataSetsAndSimulation.tex}
\clearpage
\input{Tex/ObjectSelection.tex}
\clearpage
\input{Tex/EventSelectionAndSignalRegion.tex}
\clearpage
\input{Tex/NonpromptBkgestimates.tex}
\clearpage
%\input{Tex/PromptBkgValidation.tex}
%\clearpage
\input{Tex/SystematicUncertainty.tex}
\clearpage
\input{Tex/SignalRegionObservations.tex}
\clearpage
