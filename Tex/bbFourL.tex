...
% This also need to be fixed (Abdualazem). Please make sure that "\makecell" is defined.
%\begin{table}[h!]
%\begin{center}
...
%	\midrule
%	\textbf{Jets Number}&$N_{ jets}\ge{2}$\\
%	\midrule
%	\textbf{b Jets Number}&$N_{ b jets}\ge{1}$\\
%	\midrule
%	\textbf{Quadruplet Mass}&107 GeV $<M_{ 4l}<$ 133 GeV\\
%	\bottomrule
%	\bottomrule
%\end{tabular}
%\end{center}
...
% This table need fixing (Abdualazem)
%\begin{table}[h!]
%\begin{center}
...
A VR enriched with events from the dominant backgrounds is built to check the normalization corrections. This VR only require the quadruplet satisfying $M_{ 4l}<$ 107 GeV or $M_{ 4l}>$ 133 GeV to be orthogonal to SR.
