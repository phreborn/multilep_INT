...
The following definitions are also considered:
...
\item  $H_T$ in $e\mu+\mu\mu$ channel, to estimate $NF^{HF}_{\mu}$% and decrease its correlation with $NF_{t\bar{t}W}$
\end{itemize}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=.45\textwidth]{figures/2LSS/l20tau_CRA_IntCO.png}
\includegraphics[width=.45\textwidth]{figures/2LSS/l20tau_CRB_EXTCO.png}
\includegraphics[width=.45\textwidth]{figures/2LSS/l20tau_DRll01_1b_meee.png}
\includegraphics[width=.45\textwidth]{figures/2LSS/l20tau_HT_lep_emmm.png}
\end{center}
\caption{
  Pre-fit plots of the control regions.
\label{fig:TFPreFit} }
\end{figure}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=.45\textwidth]{figures/2LSS/l20tau_CRA_IntCO_postFit.png}
\includegraphics[width=.45\textwidth]{figures/2LSS/l20tau_CRB_EXTCO_postFit.png}
\includegraphics[width=.45\textwidth]{figures/2LSS/l20tau_DRll01_1b_meee_postFit.png}
\includegraphics[width=.45\textwidth]{figures/2LSS/l20tau_HT_lep_emmm_postFit.png}
\end{center}
\caption{
  Posfit plots of the control regions.
\label{fig:TFPostFit} }
\end{figure}
